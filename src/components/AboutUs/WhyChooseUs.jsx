    ...
    <main className="container py-8 lg:py-12 mt-10 bg-[#F7F7F7] flex flex-col-reverse  items-center gap-10 px-4 mx-auto md:px-10 lg:px-20 lg:flex-row lg:items-start">
      ...
      >
        <div className="space-y-4">
          ...
          <h2 className="text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl tracking-tight md:tracking-wide w-full md:w-[70%] lg:w-[80%] xl:w-[80%] self-center flex font-krona text-black drop-shadow-md">
        ...
        <p className="text-gray-700 text-justify text-base leading-relaxed sm:text-lg lg:text-xl lg:max-w-2xl">
          At Solar Intelli Solutions, we offer unparalleled expertise in solar technology, ensuring reliable and scalable energy solutions for homes and businesses. Our robust platform enhances the efficiency of your solar systems, whether it’s a small residential setup or a large commercial installation.
        </p>
        {/* <ul className="list-inside px-2 text-gray-700 space-y-2">
          <li><strong>Expertise:</strong> Expertise in solar technology and energy management.</li>
          <li><strong>Reliability:</strong> A platform designed to optimize energy efficiency.</li>
          <li><strong>Scalability:</strong> Tailored for residential and commercial solar systems.</li>
        </ul> */}
      </div>
