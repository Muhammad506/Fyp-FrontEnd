...
const WhyChooseUs = () => {
  ...
  return (
    <main className="bg-gradient-to-b from-blue-50 to-white py-16">
      <div className="container mx-auto px-6 lg:px-20 -ml-6">
        <div className="flex flex-col lg:flex-row items-center lg:space-x-10">
          <div
            ref={imageRef}
            className={`flex justify-center lg:w-1/2 transition-transform duration-700 ${
          ...
          >
            ...
            <p className="text-lg text-gray-800 text-center lg:text-justify max-w-lg leading-relaxed">
