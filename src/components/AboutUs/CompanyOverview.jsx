...
const CompanyOverview = () => {
  ...
  return (
    <section className="bg-gradient-to-t from-blue-50  to-white mt-14">
      <main className="container mx-auto px-4 lg:px-16 py-12 lg:py-20 ">
        <div className="flex flex-col lg:flex-row items-center gap-0 lg:gap-12 lg:space-x-10 ">
          ...
          >
            <img
              className="w-full lg:w-3/4 rounded-lg shadow-xl transform  hover:scale-110 transition duration-1000"
